...
RSpec.describe Conversion, type: :model do
  ...
  it { is_expected.to validate_presence_of(:deposit_address).on(:update) }
  it { is_expected.to validate_presence_of(:max_amount) }
  it { is_expected.to validate_presence_of(:min_amount) }
  it { is_expected.to validate_presence_of(:rate) }
  it { is_expected.to validate_presence_of(:return_address).on(:update) }
  it { is_expected.to validate_presence_of(:withdrawal_address).on(:update) }
